...
export const getProveedoras = async (req: Request, res: Response) => {
  try {
...
export const createProveedora = async (req: Request, res: Response) => {
  try {
    const companyId = (req as any).user.company_id;
...
export const getConsignaciones = async (req: Request, res: Response) => {
  try {
    const companyId = (req as any).user.company_id;
...
export const createConsignacion = async (req: Request, res: Response) => {
  try {
    const companyId = (req as any).user.company_id;
...
export const getReporteProveedora = async (req: Request, res: Response) => {
  try {
    const companyId = (req as any).user.company_id;
...
export const crearLiquidacion = async (req: Request, res: Response) => {
  try {
    const companyId = (req as any).user.company_id;
    const proveedoraId = Number(req.params.proveedoraId);
